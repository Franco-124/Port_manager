...
{
    public partial class frmInformePendientes : Form
    {
        public frmInformePendientes()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            ObjWord.Selection.TypeText("Informe de Buques Pendientes ");
            ...
            // Tabla
            int filas = dtgPendientes.Rows.Count;
            int columnas = 4;
            ...
            string[] encabezados = {"Serial buque", "Id Muelle", "Accion", "Tipo carga"};
            ...
            for (int i = 0; i < filas - 1; i++)
            {
                ...
                {
                    string texto = dtgPendientes.Rows[i].Cells[j].Value?.ToString() ?? "";
            ...
            try
            {
                string fileName = $"Informe_Buques_Pendientes_{DateTime.Now:yyyyMMdd_HHmm}.pdf";
